public class AudioGlobals
{
    ...
    //SFX
    public const string EnemyDash = "SFX/EnemyDash";
    public const string EnemyYawp = "EnemyYawp";
    public const string Move = "SFX/Move";
    public const string JumpFromGround = "SFX/JumpFromGround";
    public const string Jump2 = "SFX/Jump2";
    public const string ToGround = "SFX/ToGround";
    public const string Hurt = "SFX/Hurt";
    public const string GetSans = "SFX/GetSans";
    public const string ToSansWindow = "SFX/ToSansWindow";
    public const string ToSavePointWindow = "SFX/ToSavePointWindow";
